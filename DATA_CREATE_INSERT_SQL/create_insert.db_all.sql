...
CREATE TABLE Car (
    ...
    transmission transmission_type NOT NULL, -- тип трансмиссии
...
CREATE TABLE Motorcycle (
    ...
    horsepower INT NOT NULL,                 -- мощность в лошадиных силах
    price DECIMAL(10, 2) NOT NULL,           -- цена в долларах
    type motorcycle_type NOT NULL, -- тип мотоцикла
    FOREIGN KEY (model) REFERENCES Vehicle(model)
);
...
CREATE TABLE Bicycle (
    ...
    price DECIMAL(10, 2) NOT NULL,           -- цена в долларах
    type bicycle_type NOT NULL, -- тип велосипеда
    FOREIGN KEY (model) REFERENCES Vehicle(model)
);
...
-- Создание ENUM-типа для Classes
CREATE TYPE class_type AS ENUM ('Racing', 'Street');
...
-- Создание ENUM-типа для Room
CREATE TYPE room_type_enum AS ENUM ('Single', 'Double', 'Suite');
